        ...
        private void KAREOLUSTUR(Bitmap goruntu)
        {
            ...
            foreach (Rectangle REC in RECS)
            {
                if (RECS.Length > 0)
                {
                    ...
                    using (Pen p = new Pen(Color.FromArgb(3, 26, 252), 2))
                    {
                        f.DrawRectangle(p, nesneRect);
                    }
                    int nesneXEKSENI = nesneRect.X + (nesneRect.Width / 2);
                    int nesneYEKSENI = nesneRect.Y + (nesneRect.Height / 2);
                    f.DrawString(nesneXEKSENI.ToString() + "X" + nesneYEKSENI.ToString(), new Font("Times New Roman", 40), Brushes.White, new System.Drawing.Point(0, 0));
                    f.Dispose();

                    if (nesneXEKSENI > 0 && nesneXEKSENI <= 426 && nesneYEKSENI > 0 && nesneYEKSENI <= 240)
                    {
                        LED = 2;
                    }
                    else if (nesneXEKSENI > 426 && nesneXEKSENI <= 852 && nesneYEKSENI > 0 && nesneYEKSENI <= 240)
                    {
                        LED = 3;
                    }
                    else if (nesneXEKSENI > 852 && nesneXEKSENI <= 1280 && nesneYEKSENI > 0 && nesneYEKSENI <= 240)
                    {
                        LED = 4;
                    }
                    else if (nesneXEKSENI > 0 && nesneXEKSENI <= 426 && nesneYEKSENI > 240 && nesneYEKSENI <= 480)
                    {
                        LED = 5;
                    }
                    else if (nesneXEKSENI > 426 && nesneXEKSENI <= 852 && nesneYEKSENI > 240 && nesneYEKSENI <= 480)
                    {
                        LED = 6;
                    }
                    else if (nesneXEKSENI > 852 && nesneXEKSENI <= 1280 && nesneYEKSENI > 240 && nesneYEKSENI <= 480)
                    {
                        LED = 7;
                    }
                    else if (nesneXEKSENI > 0 && nesneXEKSENI <= 426 && nesneYEKSENI > 480 && nesneYEKSENI <= 720)
                    {
                        LED = 8;
                    }
                    else if (nesneXEKSENI > 426 && nesneXEKSENI <= 852 && nesneYEKSENI > 480 && nesneYEKSENI <= 720)
                    {
                        LED = 9;
                    }
                    else if (nesneXEKSENI > 852 && nesneXEKSENI <= 1280 && nesneYEKSENI > 480 && nesneYEKSENI <= 720)
                    {
                        LED = 10;
                    }
                    if( SERIPORT != LED )
